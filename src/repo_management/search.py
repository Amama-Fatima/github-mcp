...
def get_recent_repositories(username: str, limit: int = 10) -> dict:
    """Get user's recently updated repositories as structured JSON"""
    if not GITHUB_TOKEN:
        return {"error": "⚠️ No GITHUB_TOKEN set in environment."}
...
def search_repositories_by_language(language: str, limit: int = 10, sort: str = "stars") -> dict:
...
def search_repositories_by_topic(topic: str, limit: int = 10, sort: str = "stars") -> dict:
